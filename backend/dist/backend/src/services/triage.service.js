...
class TriageService {
     ...
     */
    async simulateAITriage(rawText) {
     ...
     */
    validateAIOutput(rawOutput) {
        const parseResult = triage_validator_1.triageDecisionSchema.safeParse(rawOutput);
     ...
     */
    applyGuardrailsAndEscalation(rawText, decision) {
